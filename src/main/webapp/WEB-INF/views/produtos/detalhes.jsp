...
<title>${produto.nome} - Casa do Código</title>
...
<body>
	...
	<g class="logo-text">
		...
		<div id="navegacaoCabecalho" class="cabecalhoPrincipal-navegacao">
			...
			<a tabindex="3" href="${s:mvcUrl('CCC#listarCarrinhoItem').build()}" title="Ir para sacola de compras" class="sacola cabecalhoPrincipal-itemNavegacao">
				<svg width="28px" height="34px" viewBox="0 0 28 34" role="img" aria-labelledby="sacolaLabel" class="sacola-icone">
					<title id="sacolaLabel">
						Você tem ${carrinhoCompras.quantidadeItens} itens na sacola
					</title>
...
<form:form servletRelativeAction="/carrinho" methodParam="POST" cssClass="adicionarAoCarrinho">
	<ul class="adicionarAoCarrinho-listaOfertas">
	
		<input type="hidden" name="produtoId" value="${produto.id}">
		<input type="hidden" name="tipoPreco" id="tipoPreco">
		...
		<c:forEach items="${produto.precos}" var="preco">
			<li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
				...
				<button class="adicionarAoCarrinho-botaoComprar" name="id" value="${produto.id}" title="Compre o ${preco.tipoPreco}" onfocus="document.getElementById('tipoPreco').value='${preco.tipoPreco}'">
					Comprar
				</button>
			</li>
		</c:forEach>
...
<p class="book-description">O livro vai muito mais longe na manipula&#231;&#227;o de cole&#231;&#245;es e datas. Conhe&#231;a e comece a utilizar as novidades em seu projeto.</p>
	...
	<h2 class="infoSection-titulo">
		...
		<div class="autoresDoLivro-autor" itemprop="author" itemscope itemtype="http://schema.org/Person">
			...
			<img class="autoresDoLivro-autor-foto" itemprop="image" src="//cdn.shopify.com/s/files/1/0155/7645/files/paulo-silveira.png?13966522090502778985?v=2017-05-20" title="Foto de Paulo Silveira"><!--
		...
		<div class="autoresDoLivro-autor" itemprop="author" itemscope itemtype="http://schema.org/Person">
			...
			<img class="autoresDoLivro-autor-foto" itemprop="image" src="//cdn.shopify.com/s/files/1/0155/7645/files/rodrigo-turini.png?13966522090502778985?v=2017-05-20" title="Foto de Rodrigo Turini"><!--
			--><h3 class="autoresDoLivro-autor-nome" itemprop="name">
			  Rodrigo Turini
			</h3>
			<p class="infoSection-texto autoresDoLivro-autor-descricao" itemprop="description">
	...
	<div class="infosAdicionaisDoLivro-links" role="presentation">
		...
		<a class="infosAdicionaisDoLivro-button" href='http://erratas.casadocodigo.com.br/errata?book=Java 8 PrÃ¡tico: Lambdas, Streams e os novos recursos da linguagem'>
			Submeter errata
		</a>
...
<section class="recomendacoes">
	<div class="infoSection" role="presentation">
		<h2 class="infoSection-titulo">Impulsione sua carreira aprendendo tambÃ©m...</h2>
	</div>
	<div class="recomendacoes-livros container" role="presentation">
		<div class="recomendacoes-livro livroNaVitrine" role="presentation">
			
			<a href="/products/livro-certificacao-java-associate" class="livroNaVitrine-link" title="Java SE 8 Programmer I: O guia para sua certificaÃ§Ã£o Oracle Certified Associate">
	...
	Certifica&#231;&#227;o Java
		...
		<div class="recomendacoes-livro livroNaVitrine" role="presentation">
			...
			<a href="/products/livro-arquitetura-java" class="livroNaVitrine-link" title="IntroduÃ§Ã£o Ã  Arquitetura e Design de Software: Uma visÃ£o sobre a plataforma Java">
	<div class="livroNaVitrine-imagemContainer" role="presentation">
...
<footer class="caelum-footer">
					...
					<ul class="grupoCaelum-column-list">
						...
						<li class="column-item">
							<a href="http://www.casadocodigo.com.br">
								<img class="column-item-logo" src="//cdn.shopify.com/s/files/1/0155/7645/t/227/assets/footer-icon-cdc.svg?13966522090502778985"><span class="column-item-title">Casa do CÃ³digo</span>					
							</a>
						</li>
					</ul>
				</li>
	...
	<script type="text/javascript" src="//cdn.shopify.com/s/files/1/0155/7645/t/227/assets/trackExternalLinks.js?13966522090502778985"></script>
	
	<script type="text/javascript" src="//cdn.shopify.com/s/files/1/0155/7645/t/227/assets/userreport.js?13966522090502778985"></script>
	<script type="text/javascript" src="//cdn.shopify.com/s/files/1/0155/7645/t/227/assets/discount.js?13966522090502778985"></script>
</body>
</html>
