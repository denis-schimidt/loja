				...
				<nav id="main-nav">
					...
					<ul class="clearfix">
						<sec:authorize access="hasRole('ADMIN')" >
							<li><a href="${s:mvcUrl('PC#listarProdutos').build()}" rel="nofollow">Lista de Produtos</a></li>
	...
	<section id="index-section" class="container middle">
		...
		<ul class="clearfix book-collection">
			<c:forEach items="${produtos}" var="produto">
				<li><a href="${s:mvcUrl('PC#exibirDetalheDoProduto').arg(0,produto.id.toString()).build()}" class="block clearfix">
